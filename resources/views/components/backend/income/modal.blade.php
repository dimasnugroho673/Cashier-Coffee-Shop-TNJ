<div>
    <div class="modal modal-blur fade" id="modal-income-form" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <form id="modalIncome">
                <div class="modal-body">
                        ...
                        <div class="form-group mt-3">
                            ...
                            <select name="" id="typeincome_id" class=" form-select">
                ...
                <div class="modal-footer">
                    <button href="#" class="btn btn-link link-secondary" data-bs-dismiss="modal" id="btn-reset-form-income">
                        Cancel
                    </button>
                    <button type="submit" class="btn btn-primary ms-auto" data-bs-dismiss="modal" id="btn-submit-form-add-income">
