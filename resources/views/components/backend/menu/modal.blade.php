    ...
    <div class="modal modal-blur fade" id="tambah-data-modal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group my-3">
                        ...
                        <input type="text" class="form-control" id="name" name="name" placeholder="Masukkan nama makanan/minuman anda ...">
                    </div>
                    <div class="row my-4">
                        <div class="col-sm-6">
            ...
            <div class="modal-footer">
                <a href="#" class="btn btn-link link-secondary" id="btn-reset-form-add-menu" data-bs-dismiss="modal">
                    Cancel
                </a>
                <button type="submit" class="btn btn-primary ms-auto" data-bs-dismiss="modal" id="btn-submit-form-add-menu">
